...
public class DateWheel extends Wheel
{
    ...
    void init() {
        ...
        for (int i = minDate; i <= maxDate; ++i) {
            ...
            String currentDateStringForDisplay = currentDateString;
            if(locale == "ko")
                currentDateStringForDisplay = currentDateStringForDisplay + "일";
            this.values.add(currentDateString);
            this.displayValues.add(currentDateStringForDisplay);
        }
